function go_netviewer_Matt(C,thresh)
...
for ii = 1:length(aalviewer.centroids);
    [x y z] = sphere(10);
    sw = sphereWidths(ii);
    surf(sw*x+aalviewer.centroids(ii,1),sw*y+aalviewer.centroids(ii,2),sw*z+aalviewer.centroids(ii,3),'edgecolor','none','facecolor','b','facealpha',1);
end
