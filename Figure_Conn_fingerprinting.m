...
close all
clearvars -except resf project_dir results_dir datadir hpfs lpfs f_ind frq_cols pval all_real_diffs all_mean_within_corrs
...
xlabel('Frequency (Hz)')
set(f1,'Color','w')
set([ax1,ax2],'FontSize',13,'TickLength',[0,0],'XTickLabelRotation',70,'XTick',unique([hpfs,lpfs]));
[~,sortid]= sort(pval);
...
ax2.YLabel.String = sprintf('Correlation\n(Within-subject)');
