function PaintBrodmannAreas_chooseview(data, ...
    nr_ROIs_to_plot, nr_colors_to_plot, colour_range, cbar_label, colourbar_threshold,view_vec)
...
% map=colormap(hot(nr_colors_to_plot));
